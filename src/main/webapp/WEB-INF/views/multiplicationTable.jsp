<%@page import="multiplication.multiplicationspring.service.MultiplicationService"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> 
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%> 
<jsp:useBean id="service" class="multiplication.multiplicationspring.service.MultiplicationService" scope="page"/>
<!DOCTYPE html> 
<html lang="ko">
<head>
	<title>Home</title>
